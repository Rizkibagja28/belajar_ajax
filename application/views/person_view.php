...
<body style="font-family: 'Times New Roman'; font-size:15px;">
    <div class="container">
        <hr>
        <h1 style="" align="center">AJAX + CODEIGNITER + BOOTSTRAP + DATATABLE</h1><br>
        <small><h4>+ Belajar Upload Ke Hosting Gratis</h4>
                <h4>+ Belajar Upload ke GitHub</h4></small>
        <hr>
